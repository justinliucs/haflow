...
@Module(id = "a966ef60-f825-4ed9-146b-deef78805088", name = "FileSystem", category = "Basic", type = ModuleType.FS, configurations = {
		@ModuleConfiguration(key = "delete", displayName = "Delete", order = 1),
		@ModuleConfiguration(key = "mkdir", displayName = "Make Directory", order = 2),
		@ModuleConfiguration(key = "move", displayName = "Move", order = 3),
		@ModuleConfiguration(key = "chmod", displayName = "Change Mode", order = 4) }, inputs = { @ModuleEndpoint(name = "from", minNumber = 1, maxNumber = 1, dataType = DataType.PlainText, order = 1) }, outputs = {
