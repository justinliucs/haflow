...
<link href="static/zcss/flowchartDemo.css" rel="stylesheet"
	type="text/css" />
<link href="static/zcss/perimeterAnchorsDemo.css" rel="stylesheet"
	type="text/css" />
...
<body class="claro">
	...
	<div id="loader">
		<div id="loaderInner"
			style="direction: ltr; white-space: nowrap; overflow: visible;">Loading
			...</div>
	</div>
	...
	<div id="main" data-dojo-type="dijit.layout.BorderContainer"
			...
			<div data-dojo-type="dijit.PopupMenuBarItem" id="flow">
				...
				<div data-dojo-type="dijit.Menu" id="editMenu">
					...
					<div data-dojo-type="dijit.MenuItem" id="save2"
						data-dojo-props="iconClass:'dijitIconSave', onClick:saveFlow2">Save
						Project</div>
					<div data-dojo-type="dijit.MenuItem" id="newFlow"
						data-dojo-props="iconClass:'dijitIconUndo', onClick:rNewFlow">New
						Flow</div>
					<div data-dojo-type="dijit.MenuItem" id="newErModule"
						data-dojo-props="iconClass:'dijitIconUndo', onClick:rNewErModule">New
						ER Module</div>
				</div>
			</div>
			...
			<div data-dojo-type="dijit.PopupMenuBarItem" id="fun">
				...
				<div data-dojo-type="dijit.Menu" id="helpMenu">
					...
					<div data-dojo-type="dijit.MenuItem" id="runCurrent"
						data-dojo-props="iconClass:'dijitIconUndo', onClick:runCurrentFlow">Run
						Current</div>
				</div>
			</div>
		...
		<div data-dojo-type="dijit.layout.AccordionContainer"
			data-dojo-props="region:'leading', splitter:true, minSize:20"
			style="width: 300px;" id="leftAccordion">


			<div data-dojo-type="dijit.layout.ContentPane"
				data-dojo-props='title:"Tree"'>
				<!-- tree widget -->
				...
				<div dojoType="dojo.data.ItemFileWriteStore"
					data-dojo-props="data:fullJson" jsId="continentStore">
				...
				<div data-dojo-type="dijit/tree/ForestStoreModel"
					data-dojo-id="continentModel"
		...
		<div data-dojo-type="dijit.layout.AccordionContainer"
			data-dojo-props="region:'trailing', splitter:true, minSize:20"
			style="width: 300px;" id="rightAccordion">
			<!-- added by zhaowei -->
			<div data-dojo-type="dijit.layout.ContentPane"
				data-dojo-props='selected:true, title:"Modules List"'>
				<div class="window boxstyle" id="1">
					<strong>ER</strong>
				</div>
				<div class="window boxstyle" id="2">
					<strong>TEST</strong>
				</div>
				<div class="window boxstyle" id="3">
					<strong>HQ</strong>
				</div>
			</div>

			<div data-dojo-type="dijit.layout.ContentPane"
				data-dojo-props='selected:true, title:"Modules List 2"'>
		...
		<div data-dojo-type="dijit.layout.TabContainer"
			data-dojo-props="region:'center', tabStrip:true" id="topTabs">
	...
	<div class="dijitDialogPaneContentArea">
		<div data-dojo-type="dijit/Dialog" data-dojo-id="rNewFlowDialog"
			title="Name the Flow">
			<table class="dijitDialogPaneContentArea">
				<tr>
					<td><label for="rNewFlowName">Name:</label></td>
					<td><input data-dojo-type="dijit/form/TextBox" name="name"
						id="rNewFlowName"></td>
				</tr>
			</table>

			<div class="dijitDialogPaneActionBar">
				<button data-dojo-type="dijit/form/Button" type="submit" id="ok"
					data-dojo-props="onClick:fNewFlowNameCallBack">OK</button>
				<button data-dojo-type="dijit/form/Button" type="button"
					data-dojo-props="onClick:function(){rNewFlowDialog.hide();}"
					id="cancel">Cancel</button>
			</div>
		</div>

		<div data-dojo-type="dijit/Dialog"
			data-dojo-id="flowDeleteConfirmDialog" title="Delete Confirm">
			<div id="flowDeleteConfirmContent">Delete Flow?</div>
			<div class="dijitDialogPaneActionBar">
				<button data-dojo-type="dijit/form/Button" type="submit"
					onClick="flowDeleteConfirmCallback">Delete</button>
				<button data-dojo-type="dijit/form/Button" type="button"
					onClick="flowDeleteConfirmDialog.hide();">Cancel</button>
			</div>
		</div>
	</div>
	...
	<ul id="menuTree_menu" data-dojo-type="dijit/Menu"
		...
		<li data-dojo-type="dijit/MenuItem"><script type="dojo/connect"
				data-dojo-event="onClick">rOpenFlow(this)</script> 打开</li>
		<li data-dojo-type="dijit/MenuItem"><script type="dojo/connect"
				data-dojo-event="onClick">rNewFlow()</script> 新建</li>
		<li data-dojo-type="dijit/MenuItem"><script type="dojo/connect"
				data-dojo-event="onClick">rDeleteFlow(this);</script> 删除</li>
		<li data-dojo-type="dijit/MenuItem"><script type="dojo/connect"
				data-dojo-event="onClick">rClearFlow(this);</script> 清空</li>
		<li data-dojo-type="dijit/MenuItem"><script type="dojo/connect"
				data-dojo-event="onClick">rRunFlow(this);</script> 运行</li>
